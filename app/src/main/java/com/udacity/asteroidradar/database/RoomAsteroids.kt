...
interface AsteroidDao {
    ...
    @Query("SELECT * FROM DatabaseAsteroid WHERE closeApproachDate <= :endOfWeek ORDER BY closeApproachDate ASC")
    fun getAsteroidsWeek(endOfWeek: String): LiveData<List<DatabaseAsteroid>>
